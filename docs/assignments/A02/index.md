...
<img width="2651" height="3500" alt="IMG_7767" src="https://github.com/user-attachments/assets/0d57f541-0d39-4568-a810-cc0bfc5e8233" />

To solve for the internal forces, I drew a Free Body Diagram and calculated the forces acting on each specific point. Breaking the truss system down by each joint allows for a clear understanding on the amount of force or stress each joint is withstanding. Although, based on the calculations shown in the picture below some of the joints show that there are no forces acting on it, they do have a significant role in the structural stability of the design.
